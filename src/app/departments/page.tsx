      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {departments.map((dept, index) => (
            ...
            >
              {/* Background Gradient */}
              <div className={`absolute inset-0 bg-gradient-to-br ${dept.color} transition-all duration-300`}></div>
        ...
        <div className="mt-12 sm:mt-16 text-center">
          <div className="inline-flex items-center gap-3 px-6 py-3 bg-white rounded-full shadow-md">
            ...
            <span className="text-stone-600 text-sm sm:text-base">
              <span className="font-semibold text-stone-900">8 Departments</span> available for practice
            </span>
          </div>
        </div>
