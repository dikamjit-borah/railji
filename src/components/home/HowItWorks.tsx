  ...
  const steps = [
    {
      ...
      description: `Select from ${SITE_STATS.departments} railway departments from Civil, Mechanical, Electrical and more based on your current role or career goals.`,
      icon: (
