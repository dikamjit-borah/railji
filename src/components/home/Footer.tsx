      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-4 text-stone-400">
              <li><a href="#about" className="hover:text-white transition-colors text-xs sm:text-sm">About Us</a></li>
              <li><a href="#contact" className="hover:text-white transition-colors text-xs sm:text-sm">Contact</a></li>
              <li><a href="#privacy" className="hover:text-white transition-colors text-xs sm:text-sm">Privacy Policy</a></li>
              <li><a href="#terms" className="hover:text-white transition-colors text-xs sm:text-sm">Terms of Service</a></li>
            </ul>
          </div>
        </div>
